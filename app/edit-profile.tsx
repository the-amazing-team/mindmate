                    ...
                    <View style={styles.chipContainer}>
                        {AGE_GROUPS.map((group) => (
                            <TouchableOpacity
                                ...
                                style={[
                                    styles.chip,
                                    ageGroup === group && styles.selectedChip
                                ]}
                                onPress={() => setAgeGroup(group)}
                            >
                                <Text style={[
                                    styles.chipText,
                                    ageGroup === group && styles.selectedChipText
                                ]}>{group}</Text>
                            </TouchableOpacity>
                        ))}
                    </View>
                    ...
                    <View style={styles.chipContainer}>
                        {PERSONALITY_TYPES.map((type) => (
                            <TouchableOpacity
                                ...
                                style={[
                                    styles.chip,
                                    personality === type && styles.selectedChip
                                ]}
                                onPress={() => setPersonality(type)}
                            >
                                <Text style={[
                                    styles.chipText,
                                    personality === type && styles.selectedChipText
                                ]}>{type.charAt(0) + type.slice(1).toLowerCase()}</Text>
                            </TouchableOpacity>
                        ))}
                    </View>
                </View>
